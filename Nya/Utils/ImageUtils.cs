...
namespace Nya.Utils
{
	internal class ImageUtils
	{
		...
		public async void LoadNewNyaImage(ImageView image, Action? callback)
		{
			try
			{
				var selectedEndpoint = _pluginConfig.Nsfw ? _pluginConfig.SelectedEndpoints[_pluginConfig.SelectedAPI].SelectedNsfwEndpoint : _pluginConfig.SelectedEndpoints[_pluginConfig.SelectedAPI].SelectedSfwEndpoint;
