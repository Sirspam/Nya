...
namespace Nya.UI.ViewControllers.NyaViewControllers
{
	internal class NyaViewMenuController : NyaViewController, IInitializable, IDisposable
	{
		...
		public NyaViewMenuController(ImageUtils imageUtils, PluginConfig pluginConfig, TickableManager tickableManager, GameScenesManager gameScenesManager, FloatingScreenUtils floatingScreenUtils, SettingsModalMenuController settingsModalMenuController) : base(imageUtils, pluginConfig, tickableManager)
		{
		...
		private void MenuActivated(ScenesTransitionSetupDataSO transitionSetupData, DiContainer diContainer)
		{
			...
			if (_floatingScreenUtils.MenuFloatingScreen != null && _floatingScreenUtils.MenuFloatingScreen.isActiveAndEnabled && (_floatingScreenUtils.MenuFloatingScreen!.transform.position != PluginConfig.MenuPosition || _floatingScreenUtils.MenuFloatingScreen.transform.rotation.eulerAngles != PluginConfig.MenuRotation))
			{
