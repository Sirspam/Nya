...
namespace Nya.UI.ViewControllers.SettingsControllers
{
	...
	{
		[UIComponent("rainbow-text")] private readonly TMP_Text _rainbowText = null!;
		...
		[UIValue("version-text-value")] private string VersionText => $"{_pluginMetadata.Name} v{_pluginMetadata.HVersion} by {_pluginMetadata.Author}";

		[UIValue("rainbow-nya-available")] private bool RainbowNyaAvailable => _pluginConfig.InMenu;
