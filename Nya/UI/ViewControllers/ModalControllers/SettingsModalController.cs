...
namespace Nya.UI.ViewControllers.ModalControllers
{
	internal abstract class SettingsModalController : IInitializable, INotifyPropertyChanged
	{
		...
		[UIParams] protected readonly BSMLParserParams ParserParams = null!;
		...
		[UIComponent("root")] protected readonly RectTransform RootTransform = null!;

		[UIComponent("modal")] public readonly ModalView ModalView = null!;

		[UIComponent("modal")] protected readonly RectTransform ModalTransform = null!;

		[UIComponent("settings-modal-tab-selector")]
		protected readonly TabSelector TabSelector = null!;

		[UIComponent("nya-tab")] protected readonly Tab NyaTab = null!;

		[UIComponent("api-tab")] protected readonly Tab ApiTab = null!;

		[UIComponent("screen-tab")] protected readonly Tab ScreenTab = null!;

		[UIComponent("more-settings-tab")] protected readonly Tab MoreSettingsTab = null!;

		[UIComponent("nya-download-button")] protected readonly Button NyaDownloadButton = null!;

		[UIComponent("nya-open-button")] protected readonly Button NyaOpenButton = null!;

		[UIComponent("nsfw-checkbox")] protected readonly GenericInteractableSetting NsfwCheckbox = null!;

		[UIComponent("api-dropdown")] protected readonly DropDownListSetting ApiDropDownListSetting = null!;

		[UIComponent("sfw-dropdown")] protected readonly DropDownListSetting SfwDropDownListSetting = null!;

		[UIComponent("nsfw-dropdown")] protected readonly DropDownListSetting NsfwDropDownListSetting = null!;

		[UIComponent("api-dropdown")] protected readonly Transform ApiDropDownTransform = null!;

		[UIComponent("sfw-dropdown")] protected readonly Transform SfwDropDownTransform = null!;

		[UIComponent("nsfw-dropdown")] protected readonly Transform NsfwDropDownTransform = null!;

		[UIComponent("face-headset-button")] protected readonly Button FaceHeadsetButton = null!;

		[UIComponent("set-upright-button")] protected readonly Button SetUprightButton = null!;

		[UIComponent("default-position-button")]
		protected readonly Button DefaultPositionButton = null!;

		[UIComponent("show-handle-checkbox")] protected readonly GenericInteractableSetting ShowHandleCheckbox = null!;
		...
		[UIValue("api-list")] protected List<object> APIList = new List<object>();
		...
		[UIValue("sfw-list")] protected List<object> SfwList = new List<object>();
		...
		[UIValue("nsfw-list")] protected List<object> NsfwList = new List<object>();
